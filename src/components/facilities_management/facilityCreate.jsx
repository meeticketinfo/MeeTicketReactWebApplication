                ...
                <div className="">
                  ...
                  <Field
                    ...
                    onChange={(e) => {
                      ...
                      const Selectedfacility = adminFacilities.find(
                        (facility) =>
                          facility.facilityMasterId === Number(id)
                      );
                  ...
                  >
                    ...
                    {adminFacilities?.map((facility) => (
                      <option key={facility.facilityMasterId} value={facility.facilityMasterId}>
                    ...
                    render={(arrayHelpers) => (
                      <>
                        <div className="flex gap-4" >
                          <div>
                            {values.serviceVarientReqDTOs.map((ticket, index) => (
                              <div
                                key={index}
                                  ...
                                  <div className="grid grid-cols-3 gap-2">
                                    <div className="mb-4">
                                      ...
                                      <Field
                                        ...
                                        className={`mt-1 block w-full px-2 py-1 border ${errors.serviceVarientReqDTOs &&
                                          errors.serviceVarientReqDTOs[index] &&
                                          errors.serviceVarientReqDTOs[index].name &&
                                          touched.serviceVarientReqDTOs &&
                                          touched.serviceVarientReqDTOs[index]?.name
                                          ? "border-red-500"
                                          : "border-gray-300"
                                          } rounded-md shadow-sm focus:outline-none bg-white text-sm`}
                                    ...
                                    <div className="mb-4">
                                      ...
                                      <Field
                                        ...
                                        className={`mt-1 block w-full px-2 py-1 border ${errors.serviceVarientReqDTOs &&
                                          errors.serviceVarientReqDTOs[index] &&
                                          errors.serviceVarientReqDTOs[index].amount &&
                                          touched.serviceVarientReqDTOs &&
                                          touched.serviceVarientReqDTOs[index]?.amount
                                          ? "border-red-500"
                                          : "border-gray-300"
                                          } rounded-md shadow-sm focus:outline-none bg-white text-sm`}
