...
function StudentPassList() {
  ...
  const {
    ...
    isFetchAllallStudentPassReportsLoading,
    fetchAllStudentPassReport,
  } = useRtcReportStore();
      ...
      cellRenderer: (params) => (
        <div style={{ display: "flex align-center", gap: "0.5rem" }}>
          <span
            ...
            } text-xs font-medium me-2 px-2.5 py-0.5 rounded-md uppercase`}
          >
            {params.value}
          </span>
        </div>
  ...
  return (
    <>
      ...
      <AgGridTable
        rowData={allStudentPassReports}
        columnDefs={columnDefs}
        isFetchLoading={isFetchAllallStudentPassReportsLoading}
      />
    </>
  );
}

export default StudentPassList;
