...
function IntercityConsolidatedList() {
  ...
  const getTotalRow = () => {
    if (!IntercityConsolidateData?.length) return [];

    const totals = IntercityConsolidateData.reduce(
      (acc, row) => {
