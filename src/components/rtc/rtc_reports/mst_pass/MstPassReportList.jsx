...
function MstPassReportList() {
  // const { sidebarMenuItems, roleDetails, logout, decodedTokenData } =
  //   useAuthStore();
  const {
    allMtsPassReports,
    isFetchAllallMtsPassReportsLoading,
    fetchAllMtsPassReport,
  } = useRtcReportStore();
  console.log("DayPassDetails", allMtsPassReports);
  useEffect(() => {
    fetchAllMtsPassReport({
  ...
  return (
    <>
      ...
      <AgGridTable
      rowData={allMtsPassReports}
      columnDefs={columnDefs}
      isFetchLoading={isFetchAllallMtsPassReportsLoading}
      />
    </>
  );
}

export default MstPassReportList;
