...
function ExpressPassReportList() {
  // const { sidebarMenuItems, roleDetails, logout, decodedTokenData } =
  //   useAuthStore();
  const {
    allExpressPassReports,
    isFetchAllallExpressPassReportsLoading,
    fetchAllExpressPassReport,
  } = useRtcReportStore();
  console.log("DayPassDetails", allExpressPassReports);
  useEffect(() => {
    fetchAllExpressPassReport({
  ...
  return (
    <>
      ...
      <AgGridTable
      rowData={allExpressPassReports}
      columnDefs={columnDefs}
      isFetchLoading={isFetchAllallExpressPassReportsLoading}
      />
    </>
  );
}

export default ExpressPassReportList;
