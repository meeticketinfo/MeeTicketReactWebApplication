...
export const useCurrentIndividualStore = create((set) => ({
  ...
  fetchCurrentIndividualData: async (payload) => {
    ...
    try {
      ...
      const postBody = {
        ReportType: payload?.reportType || "INDIVIDUAL",
        DateType: dateType,
        ...
        ServiceTypeID: Number(payload?.serviceTypeID || payload?.busType || 0) || 0,
      ...
      const response = await apiService.post(
        API_ENDPOINTS.REPORTS.RTC_REPORTS.CURRENT_BOOKINGS_REPORTS.GET_CURRENT_INDIVIDUAL_REPORT,
        postBody,
        {
          token: "AmxsG7zkJB",
        }
      ...
      set({
        CurrentIndividualData: reportData,
      });
