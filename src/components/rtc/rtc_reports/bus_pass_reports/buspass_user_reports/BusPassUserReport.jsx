...
import BusPassUserReportForm from "./BusPassUserReportForm";
  ...
  return (
    <AdminLayout>
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <BusPassUserReportForm pageNumber={1} pageSize={PAGE_LIMIT} SetcurrentPage={setCurrentPage} />
        <div>
          <AgGridTable
...
export default BusPassUserReport;
