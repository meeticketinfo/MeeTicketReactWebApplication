...
const AmarabadRefundTransactionsChart = ({
  data,
  title,
  angleKey,
  calloutLabelKey,
    ...
    <div className="w-full mx-auto p-6">
      <div className="flex justify-between">
        ...
        <div className="flex items-center gap-2 bg-[#C0DDFF] rounded-lg px-4 py-3 shadow-sm">
          ...
          <Link to={`/amrabad-refund-transaction-inner-report?${searchParams.toString()}`} className="font-semibold text-lg text-[#57a4d8] ml-2 underline">
            {totalCount}
          </Link>
        </div>
      </div>
...
export default AmarabadRefundTransactionsChart;
