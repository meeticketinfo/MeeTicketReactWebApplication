...
const AmarabadNotGeneratedViewTrackOrder = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      label: subCategory ? `${subCategory.replace(/([A-Z])/g, " $1").trim()}` : "Failed (Other Reasons) Report",  
      isLast: true
    },
    {
...
export default AmarabadNotGeneratedViewTrackOrder;
