...
const AmarabadSuccessViewTrackOrder = () => {
  const {
    innerFilters,
    outerFilters,
    deepInnerFilters,
  ...
  const { orderId, mobileNumber, packageName, houseName, date, amount, bookingId, backTitle } = location.state || {};
...
export default AmarabadSuccessViewTrackOrder;
