...
import { useBookingsStore } from "../../../../store/masters/bookingsStore.js";
...
import { PaymentQR } from "../../../admin/BookTickets/PaymentQR.jsx";
import TransactionProcessingLoader from "../../../../components/bookings_management/TransactionProcessingLoader.jsx";

export default function AmrabadConsolidatedBookingDetails() {
  const { id } = useParams();
