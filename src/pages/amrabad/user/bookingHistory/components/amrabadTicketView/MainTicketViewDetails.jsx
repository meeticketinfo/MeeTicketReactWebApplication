          ...
          <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-4">
            <img
              ...
              className={`transition-all duration-300 ${
                isScrolled ? "w-[40px] sm:w-[50px] md:w-[60px]" : "w-[50px] sm:w-[60px] md:w-[85px]"
              }`}
            />
            <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-0">
              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-1">
                  ...
                  <span className="font-medium text-black text-sm sm:text-base">#ATR00089EU</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-48">
              <div className="flex flex-col gap-2 sm:gap-4">
                <div className="flex flex-col">
                  ...
                  <span className="font-medium text-black text-sm sm:text-base">12:30PM</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-medium text-gray-500 text-sm mb-1">
                    Houses:
                                     ...
                                     <span className="font-medium text-black text-sm sm:text-base">
                     {GetTicketViewDetails?.bookingItems?.length || 0}
                   </span>
                </div>
              </div>
              <div className="flex flex-col gap-2 sm:gap-4 pr-0 sm:pr-6">
                <div className="flex flex-col">
                  ...
                  <span className="font-medium text-black text-sm sm:text-base">10:30AM</span>
                </div>
                <div className="flex flex-col">
                  <span className="font-medium text-gray-500 text-sm mb-1">
                    Payment Type:
                  ...
                  {GetTicketViewDetails?.bookingItems?.map((house, index) => (
                    <tr key={index} className="">
                      ...
                      {house.discountApplicable ? (
                        ...
                        <td className="px-2 sm:px-3 py-2 sm:py-3 text-xs sm:text-sm text-black">N/A</td>
                      )}
