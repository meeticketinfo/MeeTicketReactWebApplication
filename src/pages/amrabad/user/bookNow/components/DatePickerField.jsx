      ...
      <div className="relative">
        {isCalendarLoading ? (
          ...
          <DatePicker
            ...
            calendarIconClassName="!h-5 !w-5 !cursor-pointer !right-0 !top-1/2 !transform !-translate-y-1/2 !pointer-events-auto text-[#c4a97a] fill-[#c4a97a]"
            className="w-full !pl-3 !pr-12 py-4 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c4a97a] focus:border-transparent !text-[#c4a97a]"
