      ...
      <div>
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="mb-2">
              <span className="text-2xl font-bold text-[#362D86]">₹6,500</span>
              <span className="text-gray-600 ml-2 text-lg">/ For 2 Guests</span>
            </div>

            {/* Check-in/Check-out Times */}
            <div className="bg-gray-100 rounded-lg p-4 mb-6 max-w-[400px]">
              <div className="flex items-center justify-between">
                <div className="text-gray-700">
                  <div className="text-sm text-gray-500 mb-1">Check-In Time:</div>
                  <div className="text-lg font-semibold text-[#272628]">12:30 PM</div>
                </div>
                <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center mx-4">
                ...
                <div className="text-gray-700">
                  ...
                  <div className="text-lg font-semibold text-[#272628]">10:00 AM (Next Day)</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-2 mb-2">
          <h2 className="text-base font-semibold text-gray-800 mb-1">Overview:</h2>
          <p className="text-gray-600 text-sm leading-snug mb-1">
        ...
        <div>
          <h2 className="text-base font-semibold text-gray-800 mb-1">Special Offer:</h2>
