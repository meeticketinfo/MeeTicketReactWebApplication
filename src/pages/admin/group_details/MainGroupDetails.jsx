    ...
    return (
        <AdminLayout>
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    ...
                    <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                        ...
                        {isCreate ? (
                            ...
                            <>
                                ...
                                >
                                    <span className="max-xs:sr-only">Add Group Details</span>
                                </button>
                            </>
                        )}
                    </div>
                ...
                <div>
                    {isCreate ? <CreateGroupDetails setIsCreate={setIsCreate} /> : <ViewGroupDetails setIsCreate={setIsCreate} />}
                </div>
