...
function PosConsolidatedBookingReports() {
      const {
        fetchCompletedZooCounterBookingsReport,
        allCompletedZooCounterBookingsReport,
        setisCompletedZooCounterBookings,
        isCompletedZooCounterBookingsReportLoading,
      } = useBookingsStore();
    ...
    console.log("fetchCompleteBookingsReport" ,allCompletedZooCounterBookingsReport)
      useEffect(() => {
        fetchCompletedZooCounterBookingsReport({
          ...
          cellRenderer: (params) => (
            <div style={{ display: "flex align-center", gap: "0.5rem" }}>
              <NavLink
                ...
                onClick={() => {
                  setisCompletedZooCounterBookings(true);
                }}
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div>
          ...
          <AgGridTable
            ...
            isFetchLoading={isCompletedZooCounterBookingsReportLoading}
            rowData={allCompletedZooCounterBookingsReport || []}
...
export default PosConsolidatedBookingReports;
