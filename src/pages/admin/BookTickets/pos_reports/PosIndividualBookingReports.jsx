import { useEffect, useState } from "react"; // Adjust import path as needed
...
export default function PosIndividualBookingReports() {
  ...
  const {
    ...
    isFetchNehruCounterBookingsLoading,
    totalNehruCounterBookingRecords,
  } = useDashboardStore();
  const {
    fetchAllBookings,
        ...
        {!isBookingFormVisible ? (
          <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-3">
                      ...
                      <div className="flex items-end">
                        <button
                          ...
                          // disabled={isFetchNehruCounterBookingsLoading}
                        >
                          Search
                        </button>
                      </div>
            ...
            <AgGridTable
              ...
              isFetchLoading={isFetchNehruCounterBookingsLoading}
              rowData={allNehruCounterBookings || []}
              columnDefs={columnDefs}
              // onPageChange={handlePageChange}
              totalRecords={totalNehruCounterBookingRecords}
