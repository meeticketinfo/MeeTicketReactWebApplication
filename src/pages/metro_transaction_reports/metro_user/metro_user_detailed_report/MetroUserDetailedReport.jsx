...
import MetroUserDetailedReportForm from "./MetroUserDetailedReportForm";
import { metroUserReports } from "../../../../store/metro_user_reports_store/MetroUserReportStore";

const MetroUserDetailedReport = () => {
      ...
      <AdminLayout>
        <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div className="sm:flex sm:justify-between sm:items-center mb-2">
            ...
            <div className="">
              <Link
                to={`/metro-user-report?${userReportSearchParams}`}
          ...
          <div>
            ...
            <AgGridTable
              ...
              isPagination={false}
              tableHeight={metroUserDetailedReport?.length > 10 ? 550 : 300}
              setPageLimit={setPAGE_LIMIT}
              showTotalCount={true}
              pageLimit={PAGE_LIMIT}
              handlePageClick={handlePageClick}
              currentPage={currentPage}
              totalCount={metroUserDetailedReport?.[0]?.totalCount}
...
export default MetroUserDetailedReport;
