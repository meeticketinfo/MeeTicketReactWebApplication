  ...
  return (
    <div className="gap-4 sm:gap-6 lg:gap-8 w-full p-3 sm:p-4 lg:p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 items-center lg:items-start justify-between">
        {/* Pie Chart */}
        <div className="flex-1 w-full lg:w-[60%] xl:w-[70%]">
          <div ref={chartRef} className="h-[300px] sm:h-[350px] lg:h-[400px] w-full" />
        </div>

        {data.length > 0 && (
          <div className="w-full lg:min-w-[300px] xl:min-w-[340px] lg:max-w-[40%] xl:max-w-[30%]">
            <div className="flex justify-end mb-2"></div>
            <div className="border-l-[#B7B7B7] border-r-[#B7B7B7] overflow-x-auto">
              <table className="w-full min-w-[280px]">
                <thead>
                  <tr className="bg-[#D9E4FF]">
                    <th className="text-left px-2 sm:px-3 lg:px-4 py-2 text-[#205375] font-semibold text-xs sm:text-sm">
                      Locations
                    </th>
                    <th className="text-right px-2 sm:px-3 lg:px-4 py-2 text-[#205375] font-semibold text-xs sm:text-sm">
                      Count
                    </th>
                  </tr>
                </thead>
