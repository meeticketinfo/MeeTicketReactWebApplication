...
function DashboardCard01({ lableName, count, icon: Icon }) {
  return (
    <>
      <div className="flex flex-col col-span-full sm:col-span-3 xl:col-span-3 bg-white/30 backdrop-blur-sm shadow-lg shadow-gray-200 rounded-2xl p-4 border-2 border-gray-200">
