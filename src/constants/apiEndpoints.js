...
export const API_ENDPOINTS = {
  ...
  AMRABAD_TRANSACTIONS_REPORT:{
    ...
    GET_AMARABAD_FAILED_DUE_TO_OTHER_REASONS: `${AMRABAD_API_BASE_URL}Reports/GetFailureDueToOtherReasons_SubCategoryReportResult`,
    GET_AMARABAD_FAILED_FROM_GATEWAY: `${AMRABAD_API_BASE_URL}Reports/GetFailureFromGateway_SubCategoryReportResult`,
    GET_AMARABAD_TICKET_NOT_GENERATED: `${AMRABAD_API_BASE_URL}Reports/GetPaymentSuccessButNotGenerated_SubCategoryReportResult`,
  }
};
