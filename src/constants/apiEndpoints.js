...
export const API_ENDPOINTS = {
  ...
  MASTERS: {
    ...
    COUNTER_PASS_USER: {
      ADD_NEW_COUNTER_PASS_USER: `${API_BASE_URL}Master/AddCounterPassAdmin`,
      UPDATE_COUNTER_PASS_USER: `${API_BASE_URL}Master/UpdateCounterPassAdmin`,
      GET_COUNTER_PASS_USERS: `${API_BASE_URL}Master/GetCounterPassAdmin`,
    },
    SCANNED_USER: {
